...
int main()
{
  ...
  15:	e8 31 03 00 00       	call   34b <get_max_pid>
...
printf(int fd, const char *fmt, ...)
{
 ...
 5a4:	eb 1a                	jmp    5c0 <printf+0x1a0>
          s = "(null)";
 5a6:	bb 99 07 00 00       	mov    $0x799,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5f5:	a1 48 0a 00 00       	mov    0xa48,%eax
{
...
malloc(uint nbytes)
{
 ...
 68d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 690:	8b 3d 48 0a 00 00    	mov    0xa48,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
