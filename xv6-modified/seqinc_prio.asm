  ...
  18:	83 39 01             	cmpl   $0x1,(%ecx)
{
 ...
 115:	83 c3 01             	add    $0x1,%ebx
            set_prio(priority);
 118:	53                   	push   %ebx
 119:	e8 9d 04 00 00       	call   5bb <set_prio>
            delay(20);
 11e:	c7 04 24 14 00 00 00 	movl   $0x14,(%esp)
 125:	e8 e6 00 00 00       	call   210 <delay>
            exit();
 12a:	e8 c4 03 00 00       	call   4f3 <exit>
        }
        else
        {
            printf(1, "fork error \n");
 12f:	50                   	push   %eax
 130:	50                   	push   %eax
 131:	68 05 0a 00 00       	push   $0xa05
 136:	6a 01                	push   $0x1
 138:	e8 43 05 00 00       	call   680 <printf>
            exit();
 13d:	e8 b1 03 00 00       	call   4f3 <exit>
 142:	8b 75 e0             	mov    -0x20(%ebp),%esi
