...
int main(){
  ...
  33:	56                   	push   %esi
  34:	53                   	push   %ebx
  35:	e8 59 03 00 00       	call   393 <get_proc_info>
  3a:	83 c4 10             	add    $0x10,%esp
  3d:	85 c0                	test   %eax,%eax
  3f:	78 1c                	js     5d <main+0x5d>
		{
			continue;
		}
		else
  ...
  4d:	53                   	push   %ebx
  4e:	68 f3 07 00 00       	push   $0x7f3
  53:	6a 01                	push   $0x1
  55:	e8 06 04 00 00       	call   460 <printf>
  5a:	83 c4 20             	add    $0x20,%esp
	for(pid=1;pid<=get_max_pid();pid++)
  5d:	83 c3 01             	add    $0x1,%ebx
  60:	e8 26 03 00 00       	call   38b <get_max_pid>
  65:	39 d8                	cmp    %ebx,%eax
  67:	7d c7                	jge    30 <main+0x30>

		}
	}
	exit();
  69:	e8 65 02 00 00       	call   2d3 <exit>
  6e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	eb 1a                	jmp    600 <printf+0x1a0>
          s = "(null)";
 5e6:	bb 09 08 00 00       	mov    $0x809,%ebx
        while(*s != 0){
